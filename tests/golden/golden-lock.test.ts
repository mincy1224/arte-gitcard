...
const LOCKED: Array<[string, number]> = [
  ...
  // Commit-scale pass: the commit heatmap switched to GitHub-inspired robust
  // quartile scaling (Tukey upper-fence outlier exclusion, then Q1/Q2/Q3 bins);
  // the legend shows the real quartile cutoffs, so cells/legend and heat shades
  // all changed.
  ...
  ["tests/golden/baselines/arte/structure-7d.svg", 0x80bf9b61],
  ["tests/golden/baselines/arte/structure-14d.svg", 0x581d0984],
  ["tests/golden/baselines/arte/structure-30d.svg", 0x64302404],
  ...
  ["tests/golden/baselines/github-theme/structure-7d.svg", 0x6ac9f68f],
  ["tests/golden/baselines/github-theme/structure-14d.svg", 0xd01881ab],
  ["tests/golden/baselines/github-theme/structure-30d.svg", 0xa690834f],
